...
public class GridPlotterApp
{
    ...
    private static final int DISPLAY_WIDTH = 400 * multiplier;    // in pixels
    private static final int DISPLAY_HEIGHT = 400 * multiplier;   // in pixels

    // Specify the minimum individual cell size.
    protected static final int MIN_CELL_SIZE = 10 * multiplier;   // in pixels
    ...
    private static final int LONGEST_DELAY_MSECS = 1000 / multiplier;  // slowest
    private static final int SHORTEST_DELAY_MSECS = 10 * multiplier;  // fastest
